<template>
  <div>
    ...
    <mt-field label="用户名"  :attr="{autofocus:true}"  state="error" placeholder="请输入用户名" v-model="username"></mt-field>
    <mt-field label="密码" placeholder="请输入密码" type="password"  state="error" v-model="password"></mt-field>
    <mt-field label="邮箱" placeholder="请输入邮箱" type="email" state="error" v-model="email"></mt-field>
    <mt-field label="手机号" placeholder="请输入手机号" type="tel"  state="error" v-model="phone"></mt-field>
